...
public:
  ...
  Status ExecuteGatherBcast(std::vector<TensorTableEntry>& entries, const Response& response) const;

  Status ExecuteGather(std::vector<TensorTableEntry>& entries, const Response& response) const;
  ...
  Status ExecuteBAlltoall(std::vector<TensorTableEntry>& entries, const Response& response) const;
...
private:
  ...
  std::vector<std::shared_ptr<GatherBcastOp>> gatherBcast_ops_;
  std::vector<std::shared_ptr<GatherOp>> gather_ops_;
  std::vector<std::shared_ptr<AlltoallOp>> alltoall_ops_;
  std::vector<std::shared_ptr<AllgatherOp>> balltoall_ops_;
