...
#define HOROVOD_TIMESTAMP "HOROVOD_TIMESTAMP"
...
#define HOROVOD_CPU_FUSION_THRESHOLD "HOROVOD_CPU_FUSION_THRESHOLD"
...
#define GATHER_TASK_ID_ 10
#define BROADCAT_TASK_ID_ 20 
#define ALLREDUCE_TASK_ID_ 30
class FinishedQueueForGB
{
public:
  //task_id 10 for gather and 20 for broadcast
  // FTK finished tensor key (name)
  void PushFTKsToQueue(std::string FTK);
  std::vector<std::string> GetFTKsFromQueue();
