...
extern "C" int horovod_mxnet_allgather_async(NDArray* tensor, NDArray* output,
                                             char* name);
extern "C" int horovod_mxnet_gatherBcast_async(NDArray* tensor, NDArray* output,
                                             char* name);
extern "C" int horovod_mxnet_broadcast_async(NDArray* tensor, NDArray* output,
                                             int root_rank, int num_elem, char* name, int batchid);
extern "C" int horovod_mxnet_mpibroadcast_async(NDArray* tensor, NDArray* output,
                                             int root_rank, int num_elem, char* name, int batchid);
extern "C" int horovod_mxnet_gather_async(NDArray* tensor, NDArray* output, NDArray* dep,
                                             int root_rank, int num_elem, char* name, int batchid);
extern "C" int horovod_mxnet_timestamp_async(NDArray** read_tensor, int read_len,
                                             NDArray** write_tensor, int write_len,
