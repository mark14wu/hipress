...
def get_mx_include_dirs():
    import mxnet as mx
    return [mx.libinfo.find_include_path(), mx.libinfo.find_include_path()+"../cpp-package/include/"]
...
def get_common_options(build_ext):
    ...
    if gpu_allgather and gpu_allgather != 'NCCL' and gpu_allgather != 'MPI':
